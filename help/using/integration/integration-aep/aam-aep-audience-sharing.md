...
Além disso, seus segmentos de Experience Platform são compartilhados com outras soluções de Experience Cloud, através dos [Serviços principais](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html).
...
A integração entre o Adobe Experience Platform e o Audience Manager compartilha vários [namespaces de identidade](https://experienceleague.adobe.com/docs/experience-platform/identity/namespaces.html#identity-types) padrão para todos os clientes: ECID, IDFA, GAID, endereços de email com hash (EMAIL_LC_SHA256) e AdCloud ID. Se os segmentos de Experience Platform usarem qualquer um desses itens como identidade principal para os perfis qualificados, os perfis serão contados em características e segmentos de Audience Manager.
