...
Descreve os campos obrigatórios, a sintaxe, as convenções de nomenclatura e os tamanhos de arquivo que você precisa seguir ao enviar dados para o [!DNL Audience Manager]. Defina os nomes e os tamanhos dos arquivos de acordo com essas especificações ao enviar dados para um Audience Manager [!DNL FTP] diretório.

>[!WARNING]
>
>Estamos a retirar gradualmente o apoio ao [!DNL FTP] configurações. Embora a assimilação do arquivo de dados de entrada ainda seja suportada em [!DNL FTP] , recomendamos usar [!DNL Amazon S3] para dados offline integrados para novas integrações. Consulte [Requisitos de nome e tamanho de arquivo do Amazon S3 para arquivos de dados de entrada](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) para obter detalhes.
...
<table id="table_1EA97D75004148CE85F702427DB7E97A"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>O caminho e o nome de seu <span class="keyword"> Audience Manager</span> Diretório FTP. Entre em contato com seu Gerente de contas para obter o diretório e as credenciais do FTP. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Este campo informa ao Audience Manager para qual fonte de dados integrar dados. Esse campo é obrigatório se você definir a DPID como uma ID do Android ou iOS ou outra ID pertencente a fontes de dados globais. Isso permite <span class="keyword"> Audience Manager</span> vincule os dados do arquivo à organização. <br> Essa fonte de dados de destino precisa ser de propriedade de sua empresa. Para fins de compartilhamento de dados de terceiros, para assimilar dados em uma fonte de dados de destino pertencente a outra empresa, é necessário ter um mapeamento de acesso entre a empresa e a fonte de dados de destino. Entre em contato com o consultor do Adobe ou com o Suporte ao cliente para configurar o mapeamento.</p><p><b>Observação importante:</b> Você <i>não</i> é necessário solicitar um mapeamento para os relacionamentos de compartilhamento de dados existentes (para fontes de dados do target pertencentes a outras empresas nas quais você integrou dados antes de 14 de março de 2022). O mapeamento também não é necessário ao integrar dados em fontes de dados de destino que pertencem ao seu PID. </p> <p>Por exemplo: </p> 
    <ul> 
...
[Baixar](assets/ftp_dpm_1234_1445374061.overwrite) o arquivo de amostra se você precisar de exemplos adicionais. Esse arquivo é salvo com a variável `.overwrite` extensão de arquivo. Abra-o com um editor de texto simples.

## Tamanhos de arquivo aceitos {#accepted-file-sizes}

Considere as figuras abaixo para obter o processamento mais rápido/anterior de seus arquivos, bem como para as limitações de tamanho do arquivo ao enviar dados para um [!DNL Audience Manager] / [!DNL FTP] diretório.
