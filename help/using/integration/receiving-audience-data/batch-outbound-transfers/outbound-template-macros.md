...
<table id="table_C353AF028E0A4944A8727FD01C94FDB6"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> SPLITNIO </code> </p> </td> 
...
<p>Os três últimos dígitos (001.002.003) nos exemplos acima são os identificadores SPLITNUM.</p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Um carimbo de data e hora de 10 dígitos, UTC, Unix. </p> <p>Também pode ser formatado como <code> &lt;TIMESTAMP; format="AAAMMDDhhhmmss"&gt; </code> após as regras de formatação de data/hora do Java. </p> </td> 
  </tr>
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Retorna uma lista de características. Aceita os seguintes argumentos opcionais: </p> 
    <ul id="ul_E9CDC4DD47B9435086FF42143D9E8177"> 
     <li id="li_4BBC57F0D7874F8EA8C6D39DB3572257"> <code> tipo </code>: Identifica os tipos de características por ID numérica. Devoluções: 
