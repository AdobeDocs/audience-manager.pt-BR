...
A tabela lista e descreve as macros que você pode usar no nome do arquivo e para definir campos de cabeçalho. Para exemplos de código, consulte [Exemplos de macro de saída](../../../integration/receiving-audience-data/batch-outbound-transfers/outbound-macro-examples.md).
...
<p>Os três últimos dígitos (001,002,003) nos exemplos acima são os identificadores SPLITNUM.</p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Um carimbo de data e hora de 10 dígitos, UTC e Unix. </p> <p>Ele também pode ser formatado como <code> &lt;TIMESTAMP; format="YYYYMMDDhhmmss"&gt; </code> seguindo as regras de formatação de data/carimbo de data/hora Java. </p> </td> 
  </tr>
...
Macros usadas para formatar o conteúdo de um arquivo de dados. Para exemplos de código, consulte [Exemplos de macro de saída](../../../integration/receiving-audience-data/batch-outbound-transfers/outbound-macro-examples.md).
...
<table id="table_5C6F9678CFF34C5EB67BA1DEA0479F1D"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Retorna uma lista que contém várias IDs para um parceiro de dados. Isso é útil se você tiver uma grande organização com várias subdivisões ou outros grupos organizacionais com os quais poderá compartilhar dados. Esta macro retorna uma lista de IDs para esses grupos subordinados. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> DPID </code> </p> </td> 
   <td colname="col2"> <p>ID do provedor de dados. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Retorna uma lista de segmentos em uma lista. Aceita os seguintes argumentos opcionais: </p> 
    <ul id="ul_B111AA0D6C18445598A1444B8B7E9325"> 
     <li id="li_8603B40229624856AF1FBC434DB8F16A"> <code> segmentId </code>: ID do segmento. Obsoleto. Usar <code> sid </code>. </li> 
     <li id="li_1EF40DDCA3C5447586904CF021D8F912"> <code> csegid </code>: ID do segmento do cliente. Obsoleto. Usar <code> sid </code>. </li> 
     ...
     <li id="li_DD778AA2D1DB4D409CF5026B5D9DBD27"> <code> lastUpdateTime </code>: um carimbo de data/hora Unix que indica a última vez que o status de associação do segmento foi atualizado. </li>
    ...
    <ul id="ul_E9CDC4DD47B9435086FF42143D9E8177"> 
     <li id="li_4BBC57F0D7874F8EA8C6D39DB3572257"> <code> type </code>: identifica tipos de características por ID numérica. Devoluções: 
      <ul id="ul_D2357E6CF47B4EBC8D3772D17B2EADA3"> 
       ...
       <li id="li_7AFF8A1D0E1140459CC95CF43A97B9B6"> <code> 3 </code> que identifica uma característica baseada em regras (tempo real, integrado por meio do DCS). </li> 
      </ul> </li> 
