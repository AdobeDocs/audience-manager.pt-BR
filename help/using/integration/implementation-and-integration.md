...
Trabalhar com dados de soluções [!DNL Experience Cloud] ou outros sistemas externos em [!DNL Audience Manager].
...
* [Enviar dados de público-alvo](/help/using/integration/sending-audience-data/send-audience-data.md)
