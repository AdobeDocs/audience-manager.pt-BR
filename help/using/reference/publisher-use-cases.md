---
description: Uma análise de algumas necessidades comuns do editor atendidas pelo Adobe Audience Manager.
seo-description: Uma análise de algumas necessidades comuns do editor atendidas pelo Adobe Audience Manager.
...
Uma análise de algumas necessidades comuns do editor atendidas pelo Adobe Audience Manager.
...
**Unificar a exibição do usuário e realçar o Audience Insight**
...
<table id="table_7051791195CE41B49173BBF9E581BFB6"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Crie um único repositório de público-alvo que forneça uma visão geral de todos os usuários e pontos de dados. Isso inclui informações como comportamento do site (possivelmente do Analytics), impressões de exibição, bancos de dados de registro offline, bancos de dados CRM, consumo de vídeo, iniciativas e promoções de email. </p> </td> 
   <td colname="col2"> <p> 
...
**Criar Segmentos De Público-Alvo De Publicidade Com Dados De Análises Primárias**
...
<table id="table_EE77D9F5BAD1473C8E058EE778AF2C3F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Extraia o valor máximo dos dados primários para criar segmentos acionáveis de público-alvo, empacotá-los e vender esses segmentos para anunciantes que procuram públicos específicos. </p> </td> 
   <td colname="col2"> <p>Aumente a receita monetizando os públicos-alvo em vez de o conteúdo. </p> </td> 
   <td colname="col3"> <p> 
...
**Melhorar a entrega de conteúdo personalizado do site**
  ...
  <tr> 
   <td colname="col1"> <p>Apresentar conteúdo específico ao usuário para ajudar: </p> <p> 
     <ul id="ul_ACE36F7845EB4A2E9005ECCD746495CC"> 
      <li id="li_0714139FF2F5492DA32FB95456699E54">Aumenta o tamanho do segmento, as exibições de página e as impressões. </li> 
      <li id="li_2CA4DFF2836D4F71A137829074F46D17">Crie uma experiência mais relevante para o visitante do site. </li> 
     </ul> </p> </td> 
   <td colname="col2"> <p><span class="keyword"> A análise em tempo real do Audience Manager</span>ajuda a melhorar o reconhecimento do público-alvo, o que melhora a experiência no site, fornecendo conteúdo relevante e personalizado. </p> <p>Isso lhe dá a oportunidade de adicionar a personalização do conteúdo como um item de linha aos seus produtos premium de público-alvo. </p> </td> 
   <td colname="col3"> <p> 
     <ul id="ul_EEED2DAD504C486F8C00992219C893F7"> 
      ...
      <li id="li_A9BFB7EB7504492BA83F182BE5E8CEF8">Direcione o segmento de viagem para um anunciante de linha aérea, hotel ou hospital para ajudar a melhorar a receita dos anúncios gerados pelo seu inventário. </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_F88329D45D9441F1A8EDB9D6140FD02D"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Estende compras direcionadas ao público-alvo para fontes de inventário fora do site por meio de um DSP. </p> </td> 
   <td colname="col2"> <p>Alinhe os pontos de dados de análise com anúncios de exibição no site e fora dele e monetize o inventário do público-alvo em situações de "esgotamento". </p> </td> 
   <td colname="col3"> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> 
     <ul id="ul_51091241D6B94A849A383538045D797C"> 
      ...
      <li id="li_8BAED15DF7BA41B28B51BE8DC71DFDE8">Direcione esses segmentos para otimizar a publicidade de exibição no site com o Test&amp;Target. </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col3"> <p> 
     <ul id="ul_E59B88951B454AEA8E898A64C07F0F49"> 
      <li id="li_A856501CD9AB4ABFA4A440D2F451DFD2">Responda às RFPs direcionadas à demonstração com segmentos de público-alvo prontos e de terceiros alinhados com seus dados primários. </li> 
