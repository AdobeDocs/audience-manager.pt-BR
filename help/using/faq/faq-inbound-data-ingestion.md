...
* [Requisitos de nome de FTP e tamanho de arquivo para arquivos de dados de entrada…](../integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md)
