---
description: As APIs do DIL em nível de classe permitem criar e trabalhar de forma programática com objetos do Audience Manager. As APIs de nível de classe funcionam com as outras funções de nível de instância para definir valores ou retornar dados.
...
title: Métodos do DIL em nível de classe
...
# Métodos do DIL em nível de classe{#class-level-dil-methods}
