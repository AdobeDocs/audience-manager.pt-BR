...
É possível usar vários tipos e fontes diferentes de modelos no [!DNL Audience Manager]. [!UICONTROL Audience Lab] O oferece uma maneira fácil de comparar as taxas de conversão de seus clientes com seus modelos ativos.

<!-- audience-lab-compare-models.xml -->

Nesse caso de uso, você está comparando modelos diferentes. Você pode usar modelos criados por meio de um data warehouse interno e importá-los no [!DNL Audience Manager] as [Características integradas](../../features/traits/create-onboarded-rule-based-traits.md#create-rules-based-or-onboarded-traits) ou você pode usar o [Modelos algorítmicos](../../features/algorithmic-models/understanding-models.md) recurso no [!DNL Audience Manager].
...
1. Criar [características algorítmicas](../../features/traits/create-algorithmic-traits.md) do modelo algorítmico ou importe seus próprios modelos como características integradas.
1. Crie segmentos mutuamente exclusivos para que os usuários em ambos os modelos não se sobreponham:
   ...
   * Ter a regra de segmento para *Segmento do modelo 1* ser característica do modelo 1 [!DNL AND NOT] característica do modelo 2 e vice-versa para *Segmento do modelo 2*.

1. [Criar dois grupos de teste de segmento](../../features/audience-lab/audience-lab-manage-test-groups.md#create-test-groups) in [!UICONTROL Audience Lab], um com *Segmento do modelo 1* como linha de base, o outro com *Segmento do modelo 2* como linha de base.
...
1. Examine os resultados:
   ...
   * A variável [Exibição de relatórios do Audience Lab](../../features/audience-lab/audience-lab-reporting-view.md) mostrará o número de conversões que cada modelo está conduzindo. Para campanhas baseadas em conversão, o segmento de teste que direciona mais conversões indicará o modelo com melhor desempenho.
...
Uso [!UICONTROL Audience Lab] para medir o número de conversões que um criativo está promovendo em diferentes destinos. Esse caso de uso também permite medir as conversões do criativo em relação às conversões que ocorrem naturalmente.

1. [Criar um grupo de teste de segmento](../../features/audience-lab/audience-lab-manage-test-groups.md#create-test-groups), selecionando o segmento no qual você deseja testar a criação como o segmento da linha de base.
...
1. A variável [Exibição de relatórios do Audience Lab](../../features/audience-lab/audience-lab-reporting-view.md) mostrará o número de conversões que o criativo está conduzindo nos destinos.
