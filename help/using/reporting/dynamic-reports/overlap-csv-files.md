---
description: É possível requisitar um arquivo .csv para um Relatório de sobreposição quando ele alcança o limite de 1 milhão. Um relatório pode ter atingido esse limite quando a mensagem «Erro inesperado ocorreu». Entre em contato com o Atendimento ao cliente para solicitar um arquivo. csv compactado, que você pode importar e trabalhar em seu próprio sistema de banco de dados. Os arquivos estão disponíveis para relatórios de sobreposição segmento a segmento, segmento para característica e característica de característica para característica.
seo-description: É possível requisitar um arquivo .csv para um Relatório de sobreposição quando ele alcança o limite de 1 milhão. Um relatório pode ter atingido esse limite quando a mensagem «Erro inesperado ocorreu». Entre em contato com o Atendimento ao cliente para solicitar um arquivo. csv compactado, que você pode importar e trabalhar em seu próprio sistema de banco de dados. Os arquivos estão disponíveis para relatórios de sobreposição segmento a segmento, segmento para característica e característica de característica para característica.
...
A lista de tabela a seguir descreve as convenções de nomenclatura de arquivo e as extensões de arquivo usadas em um arquivo. csv sobreposto. In the examples, *italics* indicates a variable placeholder.
...
No arquivo, os dados de string são entre aspas duplas. Veja os dados de mapeamento abaixo. Isso foi truncado para afinidade e para ajustar a tela.
...
<table id="table_1BDC7019DF2543069D7AE229C5E2454E"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> segmento_ name 1</code> </p> </td> 
   <td colname="col2"> <p>O nome do segmento que está sendo comparado aos segmentos da linha de base. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> segmento_ name 2</code> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Você pode obter relatórios para intervalos de retrospectiva de 7 e 30 dias. The <code> rangeid</code> corresponds to the time intervals shown below. </p> <p> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> Sobreposição_ perc</code> </p> </td> 
   <td colname="col2"> <p>A % sobreposta de usuários únicos entre o segmento da linha de base e os outros segmentos selecionados para comparação. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_45270B5D01014AD99921B320D3A32DB6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>A ID do provedor de dados. As IDs incluem: </p> <p> 
     <ul id="ul_B40EF144552B4BD3A1C2AE2BAFFC5A68"> 
      <li id="li_8E3B524C615F4047A5A06AF2EDF9C758"> <code> Próprio</code> </li> 
      <li id="li_F0979659028F4E2D989F1F3D1014FD3A"> <code> Terceiro</code> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> trait_ únicos</code> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>% de usuários únicos que se sobrepõem entre o trajeto e o segmento. No relatório da interface do usuário, esse número aparece na janela pop-up quando você passa o mouse sobre uma característica nos resultados do mapa de calor. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> segment_ uniques_ overlap_ perc</code> </p> </td> 
   <td colname="col2"> <p>% dos únicos usuários que se sobrepõem entre o segmento e a característica. No relatório da interface do usuário, esse número aparece na janela pop-up quando você passa o mouse sobre uma característica nos resultados do mapa de calor. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_603216E6AFE4439A87C91DDFF2989F53"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>A ID da característica que está sendo comparada com a característica da linha de base. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> overlap_ trait_ name</code> </p> </td> 
   <td colname="col2"> <p>O nome da característica que está sendo comparada com a característica da linha de base. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>O nome da linha de base que você está comparando com outras características. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> dataprovider_ type</code> </p> </td> 
   <td colname="col2"> <p>A ID do provedor de dados. As IDs incluem: </p> <p> 
     <ul id="ul_FB6FCAF484BE404B8987B54078F5E858"> 
      <li id="li_5E473205AB494D199FBDF22CAA4A1C57"> <code> Próprio</code> </li> 
      <li id="li_C9A5F455FB6D458F9DDB56EDBF5A6304"> <code> Terceiro</code> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> dataprovider</code> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> overlap_ trait_ únicos</code> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>% de usuários exclusivos que se sobrepõem entre as características selecionadas. No relatório da interface do usuário, esse número aparece na janela pop-up quando você passa o mouse sobre uma característica nos resultados do mapa de calor. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> base_ trait_ uniques_ overlap_ perc</code> </p> </td> 
   <td colname="col2"> <p>% dos únicos usuários que se sobrepõem entre as características selecionadas. No relatório da interface do usuário, esse número aparece na janela pop-up quando você passa o mouse sobre uma característica nos resultados do mapa de calor. </p> </td> 
  </tr> 
 </tbody> 
</table>
