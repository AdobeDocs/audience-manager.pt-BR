---
description: Uma lista de documentação nova ou revista divulgada em 2018 e anos anteriores. Inclui atualizações secundárias à documentação do Audience Manager que podem não ser abordadas nas notas de versão do Experience Cloud.
seo-description: Uma lista de documentação nova ou revista divulgada em 2018 e anos anteriores. Inclui atualizações secundárias à documentação do Audience Manager que podem não ser abordadas nas notas de versão do Experience Cloud.
...
Uma lista de documentação nova ou revista divulgada em 2018 e anos anteriores. Inclui atualizações secundárias à documentação do Audience Manager que podem não ser abordadas nas notas de versão do Experience Cloud.
