...
| Tópico | Descrição |
|----|----|
| [Públicos preditivos](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**Clonagem** do modelo de Audiências preditivas: Agora você pode clonar modelos existentes e alterar sua configuração com base em suas necessidades. Leia [Clonagem e edição de modelos](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences) de Audiência preditiva para obter mais informações.</li><li>**Classificação** em lote de Audiências preditivas: Além de classificar visitantes em personas distintas em tempo real, as Audiências preditivas agora oferecem suporte à classificação em lote, ajudando a classificar usuários integrados e a ativar para destinos em lote.</li></ul> |
| [Relatórios de sobreposição](/help/using/reporting/dynamic-reports/dynamic-reports.md) | Atualizamos a metodologia que usamos para calcular relatórios de sobreposição ([característica](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md), [segmento para característica](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md), [segmento para segmento](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md)). O cálculo de relatórios de sobreposição agora se baseia em únicos de relatórios e assinaturas MinHash (em vez de amostragem [de dados](/help/using/reporting/report-sampling.md#data-sampling-ratio)1/54). |
...
| [Nomes de arquivos](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) S3 de entrada e nomes de arquivos FTP de [entrada](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md) | Atualizamos as definições e fornecemos exemplos para os campos `DPID` e `DPID_TARGET_DATA_OWNER` na sintaxe do nome do arquivo. |
...
| [Novos servidores SFTP](../faq/faq-data-collection.md) | Agora você pode usar os novos [!DNL SFTP] servidores ([!DNL ftp-in-gtw] e [!DNL ftp-out-gtw]) que utilizam [!DNL AWS SFTP Gateway] o [!DNL S3]. |
