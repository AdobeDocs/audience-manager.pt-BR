...
| Tópico | Descrição |
|---- |----|
| [Correspondência de clientes do Google para destinos com base em pessoas](../features/destinations/people-based-destinations-prerequisites.md#gcm) | Agora você pode usar [!UICONTROL People-Based Destinations] para direcionar usuários por meio de [!DNL Google Customer Match]. Antes de usar [!UICONTROL People-Based Destinations] para enviar segmentos de público-alvo primários para um destino [!DNL Google Customer Match], é obrigatório que [!DNL Google] o adicione à lista de permissões. Consulte a documentação de [Destinos com base em pessoas](../features/destinations/people-based-destinations-prerequisites.md#gcm) para obter detalhes. |
