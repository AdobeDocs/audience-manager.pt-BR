...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Documentação que descreve um novo método DIL que permite enviar dados para o <span class="keyword"> Audience Manager</span> do Universal Analytics da Google. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience Manager</span> lida com os status de autenticação da ID de visitante <code> UNKNOWN</code> e <code> LOGGED_OUT</code> do mesmo modo. O documento fornece mais informações sobre como lidamos com <code> setCustomerID</code> chamadas de evento. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Novo conteúdo que descreve recursos na <span class="wintitle"> Destinos</span> página de aterrissagem. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">Adição da capacidade de proteger sua transferência de dados de saída em tempo real por meio do protocolo OAuth 2.0. Entre em contato com <span class="keyword"> Adobe Audience Manager</span> para começar. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <i>Esse recurso foi substituído.</i><p>Revisado para incluir mais informações sobre o <span class="keyword"> Device Co-op da Adobe Experience Cloud</span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../api/api-swagger-migration.md"> Migração do código API </a> </p> </td> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Atualização do conteúdo que explica por que o DIL usa <code> GET</code> e <code> POST</code> métodos para enviar dados em uma chamada de evento. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Atualização do <span class="wintitle"> Audience Optimization</span>Relatórios com Conversão entre canais, Controle de acesso com base em função, Grupos de conversão e o relatório Características de conversão relatadas. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>A variável <span class="wintitle"> Conversão entre canais</span> opção no <span class="wintitle"> Audience Optimization</span> O permite atribuir conversões offline para impressões online ou cliques. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Removido de <span class="keyword"> Audience Manager</span> em setembro de 2017. Movido para <span class="keyword"> Analytics</span> documentação. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Atualização para incluir a transmissão de IDs móveis com o <code> d_cid</code>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html" format="https" scope="external"> Segmentos Audience Manager no Analytics</a> </p> </td> 
...
<table id="table_D4EE56B5AE23497F98025E1D13CBB3A1"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Adição de um novo operador nomeado, <code> Matcheswords</code>. Ela permite especificar padrões de palavra correspondentes sem usar uma expressão regular. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md"> O que acontece depois que um provedor desativa meu feed de dados </a> </p> </td> 
   <td colname="col2"> <p>Descreve o que um <span class="wintitle"> Audience Marketplace</span> o comprador de dados pode esperar se um provedor revogar o acesso a um feed de dados. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> Códigos de erros, mensagens e exemplos de DCS </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> Captura de dados de impressão da campanha via Pixel Calls </a> </p> </td> 
   <td colname="col2"> <p>Adição de novas entradas de chave e macro para <code> d_mid</code> e <code> d_region</code>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Adição de uma nova descrição para <span class="wintitle"> Tipo de evento</span>. </p> </td> 
  </tr> 
  <tr> 
