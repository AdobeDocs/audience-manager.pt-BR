---
description: Uma lista de documentação nova e revisada do Audience Manager lançada em 2016. Inclui pequenas atualizações ou alterações no guia do Audience Manager que podem não ser incluídas nas notas de versão da Experience Cloud.
...
Uma lista de documentação nova e revisada do Audience Manager lançada em 2016. Inclui pequenas atualizações ou alterações no guia do Audience Manager que podem não ser incluídas nas notas de versão da Experience Cloud.
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <i>Este recurso foi descontinuado.</i><p>Revisão para incluir mais informações sobre o <span class="keyword"> Adobe Experience Cloud Device Co-op</span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html?lang=pt-BR" format="https" scope="external"> Cookies usados na Experience Cloud</a> </td> 
   <td colname="col2"> O valor de TTL (time-to-live) do cookie demdex e do cookie do parceiro foi modificado para 180 dias para estar em conformidade com as regulamentações CNIL francesas. </td> 
  </tr> 
  <tr> 
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html?lang=pt-BR" format="https" scope="external"> Segmentos do Audience Manager no Analytics </a> </p> </td> 
