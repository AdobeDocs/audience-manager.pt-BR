...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md#cost-attribution"> Alocação de impressão e cobrança para os feeds de dados do CPM </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> O Audience Manager <span class="keyword"> </span> define um limite máximo no número de características, segmentos, destinos e modelos algorítmicos que você pode criar para uma conta. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A3CAA532BFE7440C93BC11DEF5594D65"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Requisitos de formato e conteúdo para trazer dados para os relatórios Audience Optimization</span> do <span class="wintitle">. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E60674ACBD254365A73AB47FB840A333"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Os clientes do <span class="keyword"> Analytics</span> precisam definir um código de integração ao usar o Perfil Mestre de Marketing e transmitir IDs declaradas pelo serviço de ID de Visitante para <span class="keyword"> Audience Manager</span>. </p> <p>Este documento está obsoleto e foi substituído por <a href="../features/profile-merge-rules/merge-rules-start.md"> Criar uma Source de Dados entre Dispositivos</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Texto atualizado e novas imagens que explicam como vários sistemas <span class="keyword"> Audience Manager</span> funcionam e como os dados fluem em nosso sistema. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_EA3AF6A1987B4EFDBC84F265D5F47DC0"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="../reporting/audience-optimization-reports/aor-advertisers/import-dcm.md"> Importar arquivos de dados DCM para Audience Manager</a> </td> 
   <td colname="col2">Traga seus dados do <span class="keyword"> DoubleClick Campaign Manager</span> para o Audience Manager <span class="keyword"></span>. </td> 
  </tr> 
  <tr> 
   <td colname="col1">Métodos API e código </a> do DCS (Data Collection Server, servidor de coleta de dados)<a href="../api/dcs-intro/dcs-event-calls/dcs-event-calls.md"> </td> 
...
<table id="table_E8CD8CF9B9D3439C99AC688AFD712621"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Adição da seguinte observação: </p> <p> <p>Observação: <span class="keyword"> Audience Manager</span> não dá suporte a arquivos .zip para compartimentos S3 de entrada. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-reporting.md"> Perguntas frequentes sobre relatórios </a> </p> </td> 
