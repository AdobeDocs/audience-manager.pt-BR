---
description: Uma lista de documentação nova e revisada do Audience Manager lançada em 2015. Inclui pequenas atualizações ou alterações no guia do Audience Manager que podem não ser incluídas nas notas de versão da Experience Cloud.
...
Uma lista de documentação nova e revisada do Audience Manager lançada em 2015. Inclui pequenas atualizações ou alterações no guia do Audience Manager que podem não ser incluídas nas notas de versão da Experience Cloud.
...
<table id="table_A9AF62AC1D434B87BF4CB29BB1FE9EE0"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../reference/system-components/components-overview.md"> Componentes do sistema </a> </p> </td> 
   <td colname="col2"> <p>Remoção de informações sobre o Talend. </p> <p>Remoção de informações sobre o Netezza e sua substituição por informações sobre RedShift. </p> </td> 
  </tr> 
  <tr> 
